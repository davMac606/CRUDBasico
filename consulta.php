    ...
    include("conexaoBD.php");
     ...
     if ($_SERVER["REQUEST_METHOD"] === 'POST') {
         ...
         if (isset($_POST["ra"]) && ($_POST["ra"] != "")) {
             $ra = $_POST["ra"];
             $stmt = $pdo->prepare("select * from alunoPHP 
         ...
         try {
             ...
             while ($row = $stmt->fetch()) {
                 ...
                 if ($row["fotoFile"] == null) {
                     echo "<td align='center'>-</td>";
                 } else {
                    echo "<td align='center'><img src=".$row['fotoFile'] . " width='50px' height='50px'></td>";
                 }
                 echo "</tr>";
             }
